...
export default function EditarProjetoPage() {
  ...
  async function handleDelete() {
    if (!confirm('Excluir este projeto? Todas as atualizações associadas também serão removidas. Esta ação não pode ser desfeita.')) return
    setDeleting(true)
  ...
  if (loading) {
    return <div className="text-cream/40 text-sm">Carregando…</div>
  }
  if (notFound) {
    return (
      <div className="max-w-2xl">
        <p className="text-cream/60">Projeto não encontrado ou você não tem permissão para editá-lo.</p>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-10">
        <h1 className="font-serif text-4xl font-light text-cream mb-2">Editar projeto</h1>
        <p className="text-cream/40 text-sm">Atualize as informações do projeto.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div>
          <label className="text-cream/50 text-xs tracking-wide block mb-1.5">Status</label>
